...
namespace OWSPublicAPI.Requests.Characters
{
    ...
    /// </remarks>
    public class PublicGetByNameRequest : IRequestHandler<PublicGetByNameRequest, IActionResult>, IRequest
    {
        ...
        /// </remarks>
        public PublicGetByNameRequest(GetByNameDTO getByNameDTO, IUsersRepository usersRepository, ICharactersRepository charactersRepository, IHeaderCustomerGUID customerGuid, 
